...
A modern, responsive, and animated web-based scoreboard for the **Hazari** card game. Built with a stunning "Glassmorphism" UI, this application allows you to track scores for 4 players with ease.
...
*   **🏆 1000-Point Logic:** Automatically highlights the winner when a player crosses 1000 points.
*   **💾 Auto-Save:** Never lose your game progress! All data is saved instantly to your browser's local storage.
...
*   **JavaScript (ES6+)** - Logic, State Management, LocalStorage
*   **Canvas Confetti** - Winner animation effect
...
1.  Clone the repository:
    ```bash
    git clone https://github.com/Maijied/Hazari_Scoreboard.git
    ```
2.  Navigate to the folder:
    ```bash
    cd Hazari_Scoreboard
    ```
